...
public class Programa2 {
    ...
    public Programa2(int capacidade) {
    ...
    public int empilhaParOuImpar(int elemento) throws IllegalAccessException {
        if (elemento == 0){
            if((tamanhoPar == 0) && (tamanhoImpar == 0)){
                throw new IllegalAccessException("Está vazia");
            }
    ...
    public String toString() {
        ...
        return " Pares: " + Arrays.toString(elementosPar) +
                "\nImpares: " + Arrays.toString(elementosImpar);
    }
}